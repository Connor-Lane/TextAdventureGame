...
// Sets the value of answer to the user's entry
let answer = prompt(q1);

// NESTED CONDITIONAL STATEMENTS
// 1ST Conditional Statement
// Prompt returns the value entered as a string. That is why double equals == is used instead of triple equals === (AKA Strict Equality)
if (answer == 1) {
    answer = prompt(q2);
    if (answer == 1) {
        answer = prompt(q3);
